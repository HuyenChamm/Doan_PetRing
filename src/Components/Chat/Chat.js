    ...
    <div className='chat bg-slate-100   text-slate-900'>
      {
        isLoggedIn ?
          <div>
            <div className='py-16 container flex justify-around'>
              <div className='left w-60p   border border-solid  border-slate-400 p-3 rounded-md'>
                <div>
              ...
              {/* Friend */}
              <div className='right w-30p border border-solid  border-slate-400 p-3 rounded-md '>
                <div>
                  <div className="flex">
              ...
              <div className="bg-white rounded-lg p-8 w-full max-w-800">
                <div>
                  ...
                  <div className='boxchat px-4 '>
                    ...
                    <div className='mx-auto bg-gray-400 rounded-md h-664'>
